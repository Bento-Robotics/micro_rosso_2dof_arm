...
{
  msg_battery_state.header.frame_id = micro_ros_string_utilities_set(msg_image.header.frame_id, "base_link");
  msg_battery_state.voltage = 0.f;
  //TODO ...
};
                            ...
                            timer_descriptor &timer)
{
  if (topic_image != NULL)
  {
    ...
    pdescriptor_battery.topic_name = topic_bat;
